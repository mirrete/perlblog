...
#     NAME => q[Blog]
#     NO_META => q[1]
#     PREREQ_PM => { Catalyst::Runtime=>q[5.90090], Config::General=>q[0], Catalyst::Plugin::StackTrace=>q[0], Catalyst::Plugin::Session::Store::File=>q[0], Test::More=>q[0.88], Catalyst::Plugin::Session=>q[0], Catalyst::Plugin::Authentication=>q[0], Catalyst::Plugin::ConfigLoader=>q[0], Moose=>q[0], ExtUtils::MakeMaker=>q[6.36], Catalyst::Plugin::Session::State::Cookie=>q[0], Catalyst::Plugin::Static::Simple=>q[0], namespace::autoclean=>q[0], Catalyst::Action::RenderView=>q[0] }
#     TEST_REQUIRES => {  }
#     VERSION => q[0.01]
#     VERSION_FROM => q[lib/Blog.pm]
#     dist => { PREOP=>q[$(PERL) -I. "-MModule::Install::Admin" -e "dist_preop(q($(DISTVNAME)))"] }
#     realclean => { FILES=>q[MYMETA.yml] }
#     test => { TESTS=>q[t/01app.t t/02pod.t t/03podcoverage.t t/controller_articles.t t/controller_comments.t t/controller_user.t t/controller_Users.t t/controller_users.t t/model_DB.t t/view_HTML.t t/view_My-View.t] }
...
MAN3PODS = lib/Blog.pm \
	...
	lib/Blog/Controller/articles.pm \
...
PM_TO_BLIB = lib/Blog/Controller/Root.pm \
	...
	lib/Blog/Controller/articles.pm \
	blib/lib/Blog/Controller/articles.pm \
	lib/Blog/Controller/users.pm \
	blib/lib/Blog/Controller/users.pm \
	lib/Blog/Schema/Result/Post.pm \
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=$(MAN3EXT) --perm_rw=$(PERM_RW) \
	  ...
	  lib/Blog/Controller/users.pm $(INST_MAN3DIR)/Blog::Controller::users.$(MAN3EXT) \
	  lib/Blog/Controller/articles.pm $(INST_MAN3DIR)/Blog::Controller::articles.$(MAN3EXT) \
...
pure_all :: $(INST_SCRIPT)/blog_fastcgi.pl $(INST_SCRIPT)/blog_server.pl $(INST_SCRIPT)/blog_create.pl $(INST_SCRIPT)/blog_cgi.pl $(INST_SCRIPT)/blog_test.pl
	$(NOECHO) $(NOOP)

realclean ::
	$(RM_F) \
	  $(INST_SCRIPT)/blog_fastcgi.pl $(INST_SCRIPT)/blog_server.pl \
	  $(INST_SCRIPT)/blog_create.pl $(INST_SCRIPT)/blog_cgi.pl \
...
TEST_FILE = test.pl
TEST_FILES = t/01app.t t/02pod.t t/03podcoverage.t t/controller_articles.t t/controller_comments.t t/controller_user.t t/controller_Users.t t/controller_users.t t/model_DB.t t/view_HTML.t t/view_My-View.t
TESTDB_SW = -d
...
ppd :
	...
	$(NOECHO) $(ECHO) '    <AUTHOR>merit,,,</AUTHOR>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  ...
	  lib/Blog/Controller/articles.pm blib/lib/Blog/Controller/articles.pm \
	  lib/Blog/Controller/users.pm blib/lib/Blog/Controller/users.pm \
...
upgradedeps ::
	$(PERL) Makefile.PL --config= --upgradedeps=Catalyst::Plugin::Authentication,0,Catalyst::Plugin::Session,0,Catalyst::Plugin::Session::Store::File,0,Catalyst::Plugin::Session::State::Cookie,0,Test::More,0.88,Catalyst::Plugin::StackTrace,0,Catalyst::Runtime,5.90090,Catalyst::Plugin::ConfigLoader,0,Catalyst::Plugin::Static::Simple,0,Catalyst::Action::RenderView,0,Moose,0,namespace::autoclean,0,Config::General,0

upgradedeps_notest ::
	$(PERL) Makefile.PL --config=notest,1 --upgradedeps=Catalyst::Plugin::Authentication,0,Catalyst::Plugin::Session,0,Catalyst::Plugin::Session::Store::File,0,Catalyst::Plugin::Session::State::Cookie,0,Test::More,0.88,Catalyst::Plugin::StackTrace,0,Catalyst::Runtime,5.90090,Catalyst::Plugin::ConfigLoader,0,Catalyst::Plugin::Static::Simple,0,Catalyst::Action::RenderView,0,Moose,0,namespace::autoclean,0,Config::General,0
...
listalldeps ::
	@$(PERL) -le "print for @ARGV" Catalyst::Plugin::Authentication Catalyst::Plugin::Session Catalyst::Plugin::Session::Store::File Catalyst::Plugin::Session::State::Cookie Test::More Catalyst::Plugin::StackTrace Catalyst::Runtime Catalyst::Plugin::ConfigLoader Catalyst::Plugin::Static::Simple Catalyst::Action::RenderView Moose namespace::autoclean Config::General
